        ...
        if(event.target !== container){
            ...
            if(typeof(state)===`string`){
                ...
                if(winner.playerMark===`X`){
                    ...
                    square.innerHTML = `<svg class="tics" id="${event.target.id}" width="150px" height="150px" viewBox="0 -0.5 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
                    ...
                    state.forEach((id) =>{
                        let square = document.querySelector(`.sq${id}`)
                        square.innerHTML = `<svg class="toes" id="${event.target.id}" width="150px" height="150px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
